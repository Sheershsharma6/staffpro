  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 flex flex-wrap gap-3">
        ...
        <button
          onClick={() =>
            setFilters({ search: "", country: "", page: 1, limit: 20 })
          }
            ...
            <tbody>
              {data?.candidates?.map((c) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`inline-block px-2 py-0.5 rounded text-xs font-medium ${COUNTRY_BADGE[c.country]}`}
                    >
                      {c.country}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    {c.recruitment?.status && (
                      <span
                        className={`inline-block px-2 py-0.5 rounded text-xs font-medium ${STATUS_COLORS[c.recruitment.status] || "bg-gray-100 text-gray-700"}`}
                      >
                        {c.recruitment.status}
                      </span>
                    )}
